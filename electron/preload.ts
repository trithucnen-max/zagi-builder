...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  zalo: {
    ...
    mergeGroupMembers: (params: any) => ipcRenderer.invoke('db:mergeGroupMembers', params),
    ...
    getCalendarEventsByContact: (params: any) => ipcRenderer.invoke('db:getCalendarEventsByContact', params),
    ...
    checkPhonesDuplicate: (params: any) => ipcRenderer.invoke('db:checkPhonesDuplicate', params),
    updateContactExtraData: (params: any) => ipcRenderer.invoke('db:updateContactExtraData', params),
  },
  ...
  crm: {
    ...
    restartCampaign: (params: any) => ipcRenderer.invoke('crm:restartCampaign', params),
    retryFailedContacts: (params: any) => ipcRenderer.invoke('crm:retryFailedContacts', params),
...
// ─── License API Bridge ──────────────────────────────────────────────────────
// Expose riêng (ngoài electronAPI) để popup.html (license gate) cũng dùng được
contextBridge.exposeInMainWorld('licenseAPI', {
  verify: (email: string, licenseKey: string | null) =>
    ipcRenderer.invoke('license:verify', { email, licenseKey }),
  register: (data: unknown) =>
    ipcRenderer.invoke('license:register', data),
  activateAfterRegister: (email: string, licenseKey: string) =>
    ipcRenderer.invoke('license:activateAfterRegister', { email, licenseKey }),
  get: () =>
