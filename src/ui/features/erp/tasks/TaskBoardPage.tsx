...
const STATUS_COLS: { id: ErpTaskStatus; label: string; color: string }[] = [
  { id: 'todo',      label: 'Cần làm',    color: 'bg-gray-50 border-slate-200' },
  { id: 'doing',     label: 'Đang làm',   color: 'bg-blue-50/40 border-blue-200/60' },
  { id: 'review',    label: 'Xem xét',    color: 'bg-amber-50/40 border-amber-200/60' },
  { id: 'done',      label: 'Hoàn thành', color: 'bg-green-50/40 border-green-200/60' },
  { id: 'cancelled', label: 'Huỷ',        color: 'bg-slate-100/50 border-slate-200' },
];
