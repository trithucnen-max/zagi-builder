  ...
  interface Window {
    ...
    electronAPI: {
      ...
      crm: {
        ...
        getPhoneScanOverallStats: (params?: { timeRange?: 'all' | 'today' | 'this_week' | 'this_month' }) => Promise<{ success: boolean; stats?: { total: number; scanned: number; found: number; notFound: number; error: number; pending: number }; error?: string }>;
