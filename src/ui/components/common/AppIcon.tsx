...
export type IconType =
  ...
  | 'erp'
  | 'settings'
  // General Utility & Campaign Icons
  | 'play'
  | 'pause'
  | 'check'
  | 'x'
...
export default function AppIcon({ name, className = 'w-4 h-4', size = 16 }: AppIconProps) {
  // Outline style Lucide-like icons
  switch (name) {
    case 'conversation':
    case 'messages':
      return (
    ...
    case 'all':
      return (
        <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <line x1="12" y1="14" x2="2" y2="22" />
          <path d="M9 17l8-8-4-4-8 8z" />
        </svg>
      );
    case 'pos':
      return (
    ...
    case 'rocket':
      return (
        <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <path d="M4.5 16.5c-1.5 1.26-2 2.76-2 2.76s1.5-.5 2.76-2M22 2s-1 .5-4 2.5c-3 2-4.5 4.5-5 5.5l-3 3h3l3-3c1-.5 3.5-2 5.5-5C21.5 3 22 2 22 2z"/>
          <path d="M9 15l-3-3M2 22s1.5-2 4.5-2 4.5 2 4.5 2L10 19l-5-5-1 3.5z"/>
        </svg>
      );
    case 'dashboard':
      return (
    ...
    case 'truck':
      return (
        <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <path d="M14 18H6a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h8" /><path d="M19 18h2a2 2 0 0 0 2-2v-5l-4-4h-5v11" /><circle cx="7.5" cy="18.5" r="2.5" /><circle cx="17.5" cy="18.5" r="2.5" />
        </svg>
      );
    case 'shield_check':
      return (
    ...
    case 'bell_off':
      return (
        <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <path d="m13.73 21a2 2 0 0 1-3.46 0" />
          <path d="M18.66 13c.07-2-.36-4-1.66-5" />
          <path d="M11 5a6 6 0 0 1 7 5v1" />
          <path d="M4 4l16 16" />
          <path d="M3 17h13" />
        </svg>
      );
