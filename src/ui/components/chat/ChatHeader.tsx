      ...
      <div className="flex items-center gap-3 px-4 py-2.5">
        ...
        <div className="flex items-center gap-1">
          ...
          <button
            ...
            className={`w-8 h-8 rounded-lg flex items-center justify-center transition-colors ${showAIQuickPanel ? 'bg-blue-600 text-white' : 'hover:bg-gray-700 text-gray-400 hover:text-white'}`}
          >
