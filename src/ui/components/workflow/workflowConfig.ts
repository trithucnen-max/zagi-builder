...
export const NODE_GROUPS: NodeGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { type: 'zalo.sendVideo',          label: 'Gửi video',                  desc: 'Gửi video kèm mô tả, thumbnail, thời lượng', channel: 'zalo' },
      { type: 'zalo.sendVoice',          label: 'Gửi voice note',              desc: 'Gửi tin nhắn thoại (.m4a, .mp3) từ URL', channel: 'zalo' },
      { type: 'zalo.sendBankCard',       label: 'Gửi thẻ ngân hàng',          desc: 'Gửi thông tin tài khoản ngân hàng dạng thẻ chuyên nghiệp', channel: 'zalo' },
      { type: 'zalo.sendCard',           label: 'Gửi danh thiếp',             desc: 'Gửi danh thiếp Zalo của một người cho người khác', channel: 'zalo' },
...
export const DEFAULT_CONFIGS: Record<string, Record<string, any>> = {
  ...
  'logic.wait':            { waitType: 'relative', days: 0, hours: 0, minutes: 0, seconds: 3, calendarDays: 1, targetTime: '09:00' },
