...
20. **Thư viện Media LAN Fix, Phân loại Âm thanh & Đồng bộ tự động (v3.0.0):** Sửa lỗi tải thư mục/tag của nhân viên qua LAN, hỗ trợ loại tệp Âm thanh chuyên biệt với tab riêng, tự động sao lưu và đồng bộ toàn bộ ảnh/video/tệp/âm thanh trong chat vào Thư viện dùng chung.\n19. **Động cơ Workflow Persistent Checkpoints, Tích hợp Sapo & Tham gia nhóm Zalo (v3.0.0):**
