...
- 2026-07-27: v3.0.7 — Nâng cấp Luồng Khởi Động & Phân Quyền Bảo Mật Sếp ↔ Nhân Viên (Boss/Employee Onboarding & Security Isolation): Màn hình Onboarding chọn vai trò lần đầu, chọn Máy BOSS bắt buộc qua bước Nhập key / Nhận key dùng thử hoặc mua gói (`popup.html`), chọn Máy Nhân viên mở thẳng không cần Key. Tự động ghi nhớ workspace và boot mượt khi mở lại app. Nút `👑 Chuyển sang máy BOSS (Sếp)` trên TopBar & Cài đặt mở cửa sổ License Gate kiểm tra/xác thực Key trước khi vào Chế độ BOSS. Cô lập tuyệt đối UI Nhân viên (Ẩn workspace Default/Boss, ẩn nút Thêm/Quản lý workspace và tab Storage). Nâng cấp Quản lý Chiến dịch CRM: Sao chép chiến dịch 2 tùy chọn (👥 Sao chép CẢ Người Nhận vs 📝 KHÔNG sao chép Người Nhận); Tự động giải mã JSON Spin block thành Định dạng Kịch bản Tin nhắn thân thiện; Dashboard Báo cáo Chiến dịch Vibrant Gradient (4 thẻ chỉ số nổi bật: Tổng số, Thành công, Thất bại, Đang chờ). Bộ lọc Thời gian Quét Zalo (Hôm nay, Tuần này, Tháng này, Tùy chọn).
