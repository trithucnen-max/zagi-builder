...
- 2026-07-18: v3.0.1 final — Sửa lỗi TS2305 `hasUnseenChangelog`/`markChangelogSeen` thiếu trong settingsSeenTabs.ts; Clean-code Priority 1: xóa `autoImportFromChat`, `scheduleSave`, TEMPLATE_VARS duplicate (-116 dòng), thêm MAX_CAMPAIGN_CONTACTS constant
