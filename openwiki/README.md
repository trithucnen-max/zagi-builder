...
- 2026-07-17: Updated patterns.md and services.md with Zalo Main Process EventBroadcaster event filtering middleware and Zalo Group ID parameter prefix-stripping (v3.0.0)
- 2026-07-16: Added dedicated Audio classification, disabled automatic chat attachment library sync, implemented database cleanup sync (Option B) for cleared media messages, and fixed Employee LAN Library load folders/tags array resolution (v3.0.0)
