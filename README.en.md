...
> **Latest version: v27.2.9** — [View all versions](#changelog)
...
> ⚠️ **Surface ARM64**: If you use **Surface Pro X / Pro 9 5G / Pro 10 / Pro 11 / Laptop 7**, download `Zagi-Setup-27.2.9-arm64.exe` for native ARM64 performance — better battery life and faster than running the x64 build under emulation.
> 
> **Surface Pro 7 and older (Intel x64)**: use the standard `Zagi-Setup-27.2.9-x64.exe`.
...
<details open>
<summary><strong>v27.2.9</strong> — 2026-07-09 · <em>🟢 Current version</em></summary>
