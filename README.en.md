...
[![Linux](https://img.shields.io/badge/Ubuntu%2FDebian-v3.0.7-e95420?style=for-the-badge&logo=ubuntu&logoColor=white)](https://github.com/trithucnen-max/zagi-builder/releases/download/v3.0.7/Zagi.v3.0.7.Window.exe)

**[Zagi.v3.0.7.Window.exe (Wine)](https://github.com/trithucnen-max/zagi-builder/releases/download/v3.0.7/Zagi.v3.0.7.Window.exe)**  
**[Zagi.v3.0.7.MacOS.M1+.arm64.dmg](https://github.com/trithucnen-max/zagi-builder/releases/download/v3.0.7/Zagi.v3.0.7.MacOS.M1%2B.arm64.dmg)**
