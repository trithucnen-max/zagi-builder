...
> **Latest version: v3.0.7** — [View all versions](#changelog)
...
**[Zagi.v3.0.7.Window.exe (Wine)](https://github.com/trithucnen-max/zagi-builder/releases/download/v3.0.8/Zagi.v3.0.8.Window.exe)**  
**[Zagi.v3.0.7.MacOS.M1+.arm64.dmg](https://github.com/trithucnen-max/zagi-builder/releases/download/v3.0.8/Zagi.v3.0.8.MacOS.M1%2B.arm64.dmg)**
