...
> **Phiên bản mới nhất: v27.1.3** — [Xem tất cả phiên bản](#changelog)
...
└─ Fedora, Arch, openSUSE hoặc bất kỳ distro nào
    → Tải .AppImage  ✅
    chmod +x Zagi-27.1.3.AppImage && ./Zagi-27.1.3.AppImage
```
...
|---|---|---|
| PC/Laptop Windows (Intel/AMD) | `Zagi-Setup-27.1.3-x64.exe` | Phổ biến nhất |
| Surface Pro 7 trở xuống | `Zagi-Setup-27.1.3-x64.exe` | Chip Intel |
| Surface Pro X, 9 5G, 10, 11, Laptop 7 | `Zagi-Setup-27.1.3-arm64.exe` | 🆕 Chip ARM64 |
| MacBook M1/M2/M3/M4 | `Zagi-27.1.3-arm64.dmg` | Apple Silicon |
| MacBook/iMac Intel | `Zagi-27.1.3.dmg` | Intel x64 |
| Ubuntu/Debian Linux | `zagi_27.1.3_amd64.deb` | Cài như package |
| Fedora/Arch/Linux khác | `Zagi-27.1.3.AppImage` | Chạy mọi distro |
...
<details open>
<summary><strong>v27.1.3</strong> — 2026-06-23 · <em>🟢 Phiên bản hiện tại</em></summary>
