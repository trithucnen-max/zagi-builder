...
> **Phiên bản mới nhất: v3.1.4** — [Xem tất cả phiên bản](#changelog)
...
[![Windows](https://img.shields.io/badge/Windows_10%2F11-v3.1.4-0078d4?style=for-the-badge&logo=windows&logoColor=white)](https://github.com/trithucnen-max/zagi-builder/releases/download/v3.1.4/Zagi.v3.1.4.Window.exe)

**[Zagi.v3.1.4.Window.exe](https://github.com/trithucnen-max/zagi-builder/releases/download/v3.1.4/Zagi.v3.1.4.Window.exe)**
...
[![macOS ARM](https://img.shields.io/badge/macOS_M1%2FM2%2FM3-v3.1.4-000000?style=for-the-badge&logo=apple&logoColor=white)](https://github.com/trithucnen-max/zagi-builder/releases/download/v3.1.4/Zagi.v3.1.4.MacOS.M1%2B.arm64.dmg)

**[Zagi.v3.1.4.MacOS.M1+.arm64.dmg](https://github.com/trithucnen-max/zagi-builder/releases/download/v3.1.4/Zagi.v3.1.4.MacOS.M1%2B.arm64.dmg)**
...
[![macOS Intel](https://img.shields.io/badge/macOS_Intel-v3.1.4-555555?style=for-the-badge&logo=apple&logoColor=white)](https://github.com/trithucnen-max/zagi-builder/releases/download/v3.1.4/Zagi.v3.1.4.MacOS.Intel.dmg)

**[Zagi.v3.1.4.MacOS.Intel.dmg](https://github.com/trithucnen-max/zagi-builder/releases/download/v3.1.4/Zagi.v3.1.4.MacOS.Intel.dmg)**
...
[![Linux](https://img.shields.io/badge/Ubuntu%2FDebian-v3.1.4-e95420?style=for-the-badge&logo=ubuntu&logoColor=white)](https://github.com/trithucnen-max/zagi-builder/releases/download/v3.1.4/Zagi.v3.1.4.Linux.AppImage)

**[Zagi.v3.1.4.Linux.AppImage](https://github.com/trithucnen-max/zagi-builder/releases/download/v3.1.4/Zagi.v3.1.4.Linux.AppImage)**  
**[Zagi.v3.1.4.Linux.Debian.deb](https://github.com/trithucnen-max/zagi-builder/releases/download/v3.1.4/Zagi.v3.1.4.Linux.Debian.deb)**
...
[![Surface ARM64](https://img.shields.io/badge/💻_Surface_ARM64-v3.1.4-0078d4?style=for-the-badge&logo=windows&logoColor=white)](https://github.com/trithucnen-max/zagi-builder/releases/download/v3.1.4/Zagi.v3.1.4.Surface.exe)

**[Zagi.v3.1.4.Surface.exe](https://github.com/trithucnen-max/zagi-builder/releases/download/v3.1.4/Zagi.v3.1.4.Surface.exe)**
...
│   └─ → Tải: Zagi v3.1.4 MacOS M1+ arm64.dmg  ✅
│
└─ 🍎 MacBook, iMac, Mac mini chip Intel (2019 trở về trước)
    └─ → Tải: Zagi v3.1.4 MacOS Intel.dmg  ✅
```

> 💡 **Cách kiểm tra:** Click logo Apple → **About This Mac** → xem mục **Chip** hoặc **Processor**:
> - Có chữ `Apple M1/M2/M3/M4/A18` → bản `Zagi v3.1.4 MacOS M1+ arm64.dmg`
> - Có chữ `Intel` → bản `Zagi v3.1.4 MacOS Intel.dmg`
...
│   sudo dpkg -i "Zagi v3.1.4 Linux Debian.deb"
│
└─ Fedora, Arch, openSUSE hoặc bất kỳ distro nào
    → Tải .AppImage  ✅
    chmod +x "Zagi v3.1.4 Linux.AppImage" && ./"Zagi v3.1.4 Linux.AppImage"
```
...
|---|---|---|
| PC/Laptop Windows (Intel/AMD) | `Zagi v3.1.4 Window.exe` | Phổ biến nhất |
| Surface Pro 7 trở xuống | `Zagi v3.1.4 Window.exe` | Chip Intel |
| Surface Pro X, 9 5G, 10, 11, Laptop 7 | `Zagi v3.1.4 Surface.exe` | 🆕 Chip ARM64 |
| MacBook M1/M2/M3/M4 / Mac Neo A18 | `Zagi v3.1.4 MacOS M1+ arm64.dmg` | Apple Silicon (Signed & Notarized) |
| MacBook/iMac Intel | `Zagi v3.1.4 MacOS Intel.dmg` | Intel x64 (Signed & Notarized) |
| Ubuntu/Debian Linux | `Zagi v3.1.4 Linux Debian.deb` | Cài như package |
| Fedora/Arch/Linux khác | `Zagi v3.1.4 Linux.AppImage` | Chạy mọi distro |
...
### 🍎 macOS
* ⚠️ **Lưu ý:** Kể từ phiên bản v3.1.4, để phát hành nhanh chóng, bước ký số (Code Signing) tạm thời được bỏ qua. Khi chạy ứng dụng lần đầu, bạn sẽ gặp cảnh báo bảo mật từ Gatekeeper (*"Zagi is damaged and can't be opened"* hoặc *"unidentified developer"*).
...
```bash
chmod +x "Zagi v3.1.4 Linux.AppImage"
./"Zagi v3.1.4 Linux.AppImage"
```
...
<details open>
<summary><strong>v3.1.4</strong> — 2026-07-24 · <em>🟢 Phiên bản hiện tại</em></summary>
...
<details>
<summary><strong>v3.1.4</strong> — 2026-07-22</summary>
...
- 🍏 **Ký Số & Notarize macOS Chính Thức**:
  - Toàn bộ bản cài đặt macOS (`Zagi v3.1.4 MacOS M1+ arm64.dmg` và `Intel.dmg`) được ký số bằng chứng thư Apple Developer ID chính thức của **BASAN CORPORATION** và notarized với Apple.

</details>


<details>
<summary><strong>v3.1.4</strong> — 2026-07-18</summary>
...
- 🌐 **Sửa lỗi link tải thủ công (404 Error)**: Thay đổi các đường dẫn tải macOS/Linux thủ công ở giao diện trỏ trực tiếp về GitHub Releases với quy định đặt tên tệp thống nhất (`Zagi v3.1.4 MacOS M1+ arm64.dmg`, `Zagi v3.1.4 MacOS Intel.dmg`, `Zagi v3.1.4 Linux Debian.deb`).
...
- 🧹 **Dọn dẹp dead code (−116 dòng)**: Xóa `autoImportFromChat()` (bị vô hiệu hoá từ v3.1.4), `scheduleSave()` (no-op), `TEMPLATE_VARS` local copy; thêm hằng số `MAX_CAMPAIGN_CONTACTS` thay magic number.
...
<details>
<summary><strong>v3.1.4</strong> — 2026-07-17</summary>
