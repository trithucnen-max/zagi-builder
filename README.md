...
[![Version](https://img.shields.io/github/v/release/trithucnen-max/zagi-builder?label=phiên%20bản&color=22c55e&style=flat-square)](https://github.com/trithucnen-max/zagi-builder/releases/latest)
[![Downloads](https://img.shields.io/github/downloads/trithucnen-max/zagi-builder/total?color=22c55e&label=lượt%20tải&style=flat-square)](https://github.com/trithucnen-max/zagi-builder/releases)
[![Platform](https://img.shields.io/badge/platform-Windows%20%7C%20macOS%20%7C%20Linux-3b82f6?style=flat-square)](#tải-xuống)
...
[![License](https://img.shields.io/badge/license-MIT-22c55e?style=flat-square)](#giấy-phép)
...
> **Phiên bản mới nhất: v3.1.1** — [Xem tất cả phiên bản](#changelog)
...
[![Windows](https://img.shields.io/badge/Windows_10%2F11-v3.1.1-0078d4?style=for-the-badge&logo=windows&logoColor=white)](https://github.com/trithucnen-max/zagi-builder/releases/download/v3.1.1/Zagi.v3.1.1.Window.exe)

**[Zagi.v3.1.1.Window.exe](https://github.com/trithucnen-max/zagi-builder/releases/download/v3.1.1/Zagi.v3.1.1.Window.exe)**
...
[![macOS ARM](https://img.shields.io/badge/macOS_M1%2FM2%2FM3-v3.1.1-000000?style=for-the-badge&logo=apple&logoColor=white)](https://github.com/trithucnen-max/zagi-builder/releases/download/v3.1.1/Zagi.v3.1.1.MacOS.M1%2B.arm64.dmg)

**[Zagi.v3.1.1.MacOS.M1+.arm64.dmg](https://github.com/trithucnen-max/zagi-builder/releases/download/v3.1.1/Zagi.v3.1.1.MacOS.M1%2B.arm64.dmg)**
...
[![macOS Intel](https://img.shields.io/badge/macOS_Intel-v3.1.1-555555?style=for-the-badge&logo=apple&logoColor=white)](https://github.com/trithucnen-max/zagi-builder/releases/download/v3.1.1/Zagi.v3.1.1.MacOS.Intel.dmg)

**[Zagi.v3.1.1.MacOS.Intel.dmg](https://github.com/trithucnen-max/zagi-builder/releases/download/v3.1.1/Zagi.v3.1.1.MacOS.Intel.dmg)**
...
[![Linux](https://img.shields.io/badge/Ubuntu%2FDebian-v3.1.1-e95420?style=for-the-badge&logo=ubuntu&logoColor=white)](https://github.com/trithucnen-max/zagi-builder/releases/download/v3.1.1/Zagi.v3.1.1.Linux.AppImage)

**[Zagi.v3.1.1.Linux.AppImage](https://github.com/trithucnen-max/zagi-builder/releases/download/v3.1.1/Zagi.v3.1.1.Linux.AppImage)**  
**[Zagi.v3.1.1.Linux.Debian.deb](https://github.com/trithucnen-max/zagi-builder/releases/download/v3.1.1/Zagi.v3.1.1.Linux.Debian.deb)**
...
[![Surface ARM64](https://img.shields.io/badge/💻_Surface_ARM64-v3.1.1-0078d4?style=for-the-badge&logo=windows&logoColor=white)](https://github.com/trithucnen-max/zagi-builder/releases/download/v3.1.1/Zagi.v3.1.1.Surface.exe)

**[Zagi.v3.1.1.Surface.exe](https://github.com/trithucnen-max/zagi-builder/releases/download/v3.1.1/Zagi.v3.1.1.Surface.exe)**
...
│   └─ → Tải: Zagi v3.1.1 MacOS M1+ arm64.dmg  ✅
│
└─ 🍎 MacBook, iMac, Mac mini chip Intel (2019 trở về trước)
    └─ → Tải: Zagi v3.1.1 MacOS Intel.dmg  ✅
```

> 💡 **Cách kiểm tra:** Click logo Apple → **About This Mac** → xem mục **Chip** hoặc **Processor**:
> - Có chữ `Apple M1/M2/M3/M4/A18` → bản `Zagi v3.1.1 MacOS M1+ arm64.dmg`
> - Có chữ `Intel` → bản `Zagi v3.1.1 MacOS Intel.dmg`
...
│   sudo dpkg -i "Zagi v3.1.1 Linux Debian.deb"
│
└─ Fedora, Arch, openSUSE hoặc bất kỳ distro nào
    → Tải .AppImage  ✅
    chmod +x "Zagi v3.1.1 Linux.AppImage" && ./"Zagi v3.1.1 Linux.AppImage"
```
...
|---|---|---|
| PC/Laptop Windows (Intel/AMD) | `Zagi v3.1.1 Window.exe` | Phổ biến nhất |
| Surface Pro 7 trở xuống | `Zagi v3.1.1 Window.exe` | Chip Intel |
| Surface Pro X, 9 5G, 10, 11, Laptop 7 | `Zagi v3.1.1 Surface.exe` | 🆕 Chip ARM64 |
| MacBook M1/M2/M3/M4 / Mac Neo A18 | `Zagi v3.1.1 MacOS M1+ arm64.dmg` | Apple Silicon (Signed & Notarized) |
| MacBook/iMac Intel | `Zagi v3.1.1 MacOS Intel.dmg` | Intel x64 (Signed & Notarized) |
| Ubuntu/Debian Linux | `Zagi v3.1.1 Linux Debian.deb` | Cài như package |
| Fedora/Arch/Linux khác | `Zagi v3.1.1 Linux.AppImage` | Chạy mọi distro |
...
### 🍎 macOS
* ⚠️ **Lưu ý:** Kể từ phiên bản v3.1.1, để phát hành nhanh chóng, bước ký số (Code Signing) tạm thời được bỏ qua. Khi chạy ứng dụng lần đầu, bạn sẽ gặp cảnh báo bảo mật từ Gatekeeper (*"Zagi is damaged and can't be opened"* hoặc *"unidentified developer"*).
...
```bash
chmod +x "Zagi v3.1.1 Linux.AppImage"
./"Zagi v3.1.1 Linux.AppImage"
```
...
<p align="center">
  <img src="./assets/deplao-overview-map.svg" alt="Zagi — Tổng quan ứng dụng" width="960" />
</p>

<table>
  <tr>
    <td><img src="./assets/dashboard.png" alt="Dashboard đa tài khoản" width="320"/><br/><sub><strong>Dashboard đa tài khoản</strong></sub></td>
    <td><img src="./assets/chat.png" alt="Hộp thư hợp nhất với AI" width="320"/><br/><sub><strong>Hộp thư hợp nhất + AI</strong></sub></td>
    <td><img src="./assets/crm.png" alt="CRM quản lý liên hệ" width="320"/><br/><sub><strong>CRM & Quản lý liên hệ</strong></sub></td>
  </tr>
  <tr>
    <td><img src="./assets/scan-members-group.png" alt="Quét thành viên nhóm Zalo" width="320"/><br/><sub><strong>Quét thành viên nhóm</strong></sub></td>
    <td><img src="./assets/campaign.png" alt="Chiến dịch nhắn tin hàng loạt" width="320"/><br/><sub><strong>Chiến dịch nhắn tin hàng loạt</strong></sub></td>
    <td><img src="./assets/workflow.png" alt="Workflow tự động hóa" width="320"/><br/><sub><strong>Workflow tự động hóa</strong></sub></td>
  </tr>
  <tr>
    <td><img src="./assets/detail-workflow.png" alt="Cấu hình node workflow" width="320"/><br/><sub><strong>Cấu hình node chi tiết</strong></sub></td>
    <td><img src="./assets/workflow-ai.png" alt="Tạo workflow bằng AI" width="320"/><br/><sub><strong>Tạo workflow bằng AI</strong></sub></td>
    <td><img src="./assets/pos.png" alt="Tích hợp POS & vận chuyển" width="320"/><br/><sub><strong>POS, vận chuyển & thanh toán</strong></sub></td>
  </tr>
  <tr>
    <td><img src="./assets/report.jpg" alt="Báo cáo & phân tích" width="320"/><br/><sub><strong>Báo cáo & phân tích</strong></sub></td>
    <td><img src="./assets/report-employee.png" alt="Báo cáo nhân viên" width="320"/><br/><sub><strong>Hiệu suất nhân viên</strong></sub></td>
    <td><img src="./assets/erp.png" alt="ERP nội bộ" width="320"/><br/><sub><strong>ERP nội bộ</strong></sub></td>
  </tr>
</table>
...
```mermaid
flowchart TB
    subgraph BOSS["🖥️ Máy Sếp — Local Workspace"]
        BZ("📱 Zalo / FB\nAccounts")
        BSV("🔧 Services\nCRM · ERP · AI · Workflow")
        BSD[("🗄️ SQLite DB\n+ Media Files")]
    ...
    subgraph EMP["💻 Máy Nhân viên"]
        EA("📲 Zagi App\nEmployee Mode")
        EP("🔐 Phân quyền\nerp · crm · workflow · ...")
        EU("👁️ UI\nchỉ tài khoản được giao")
    end
    BZ --> BSV
    BSV <--> BSD
    BSV --> BRL
...
<details open>
<summary><strong>v3.1.1</strong> — 2026-07-24 · <em>🟢 Phiên bản hiện tại</em></summary>

### 🚀 Nâng cấp nổi bật & Sửa lỗi hệ thống

- 🏷️ **Nâng Cấp Logic Gán Nhãn & Sửa Lỗi Hiển Thị Nhãn Tự Động (`PhoneScanService.ts` & `DatabaseService.ts`)**:
  - **Tự Động Mở Rộng Scope Nhãn (`page_ids` Auto-Expand)**: Nâng cấp hàm `assignLocalLabelToThread` và `getLocalLabels` tự động bổ sung tài khoản chạy quét vào danh sách scope nhãn (`page_ids`), đảm bảo mọi tài khoản Zalo nhận liên hệ đều tải về và hiển thị đúng Badge màu nhãn trực quan.
  - **Khắc Phục Lỗi Trôi Nhãn Khi Gộp SĐT (`mergeDuplicateContactsByPhone`)**: Chuyển giao 100% các nhãn thuộc `local_label_threads` từ SĐT/UID phụ sang UID chính khi gộp liên hệ trùng SĐT, bảo toàn nhãn không bị trôi hay mồ côi.
  - **Bộ Chọn Scope Trực Quan Trong Modal (`UnifiedLabelPickerModal.tsx`)**: Mặc định tạo nhãn Local là **Global (`🌐 Tất cả`)** để hệ thống phễu CRM đồng nhất giữa tất cả các tài khoản Zalo. Thêm nút chuyển đổi Scope `🌐 Tất cả` (Global) vs `👤 Nhãn riêng` trực quan.
...
<details>
<summary><strong>v3.1.1</strong> — 2026-07-22</summary>
...
- 🍏 **Ký Số & Notarize macOS Chính Thức**:
  - Toàn bộ bản cài đặt macOS (`Zagi v3.1.1 MacOS M1+ arm64.dmg` và `Intel.dmg`) được ký số bằng chứng thư Apple Developer ID chính thức của **BASAN CORPORATION** và notarized với Apple.

</details>


<details>
<summary><strong>v3.1.1</strong> — 2026-07-18</summary>
...
- 🌐 **Sửa lỗi link tải thủ công (404 Error)**: Thay đổi các đường dẫn tải macOS/Linux thủ công ở giao diện trỏ trực tiếp về GitHub Releases với quy định đặt tên tệp thống nhất (`Zagi v3.1.1 MacOS M1+ arm64.dmg`, `Zagi v3.1.1 MacOS Intel.dmg`, `Zagi v3.1.1 Linux Debian.deb`).
...
- 🧹 **Dọn dẹp dead code (−116 dòng)**: Xóa `autoImportFromChat()` (bị vô hiệu hoá từ v3.1.1), `scheduleSave()` (no-op), `TEMPLATE_VARS` local copy; thêm hằng số `MAX_CAMPAIGN_CONTACTS` thay magic number.
...
<details>
<summary><strong>v3.1.1</strong> — 2026-07-17</summary>
